...
<body>
	<div id="app">
		...
		<div class="app-content">
			...
			<div class="main">
				<div class="container">
					<form class="theform2" role="form" method="post" action="betweendates-detailsreports.php">
						<h3 class="mainTitle">تقارير المرضى حسب التاريخ</h3>
						<p class="panel-title">اختار تاريخ معين لعرض تقارير المرضى</p>
