			...
			<div class="main">
				<div class="container" id="container">
					<div class="tablediv">
						<div class="row">
							<div class="col-md-12">
								<h3 class="over-title margin-bottom-15"><span class="text-bold">التقرير الطبي للمريض</span></h3>
								<?php
								$vid = $_GET['viewid'];
								...
								?>
									...
									?>
									<table id="datatable" class="table medhistory dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										<tr align="center">
